...
--
-- Хост: 127.0.0.1:3306
-- Време на генериране: 11 март 2022 в 21:06
...
INSERT INTO `cosmic_literature` (`literature_id`, `literature_link`) VALUES
(1, 'https://chitanka.info/text/21216-kosmos'),
(2, 'https://chitanka.info/text/21614-mitove-i-legendi-za-syzvezdijata'),
(3, 'https://minimummart.com/nauka/astrofizika-za-zaeti-hora-iztegljane-na-knigata/'),
(4, 'https://chitanka.info/text/29146-drugata-strana-na-nebeto'),
(5, 'https://chitanka.info/text/80-zovyt-na-zvezditeю');
...
(1, 'Интересен факт за Меркурий е, че ако комбинираме орбитата му заедно с едно пълно завъртане около оста му, получаваме, че един меркуриански ден е равен на две меркуриански години.', NULL),
(2, 'Интересен факт за Меркурий е, че ако комбинираме орбитата му заедно с едно пълно завъртане около оста му, получаваме, че един меркуриански ден е равен на две меркуриански години.\r\n>Към момента няма отговор кой точно е откривателят на Меркурий. Планетата се вижда от Земята с просто око, затова данни за нея са известни още от Древността. Първите \r\nрегистрирани наблюдения датират поне от първото хилядолетие пр.н.е. През IV век пр.н.е. древногръцките астрономи смятали планетата за два отделни обекта – единият \r\nвидим при изгрев, който те наричат Аполон, а другият – при залез, наричан Хермес.', NULL),
(3, 'За разлика от другите планети в Слънчевата система, въртенето на Венера е по часовниковата стрелка.\r\n>Атмосферата на Венера е най-тежка от всички планети в Слънчевата система. Тя съдържа предимно въглероден диоксид с малки количества азот.', NULL),
(4, 'За разлика от имената на останалите планети, кръстени на богове от римската или гръцката митология, Земята е получила името си преди поне 1000 години, като резултат на културните разбирания на хората. Всеки език си има негово име за планетата – например „Еarth“ на английски, „Тerra“ на португалски, „Аarde“ на холандски. Общото между наименованието й на всички езици е, че значението е почти едно и също – земя или почва.', NULL),
(5, 'Марс от разстояние изглежда розово-червеникав, поради наличието на малки твърди частици железен оксид.', NULL),
(6, 'Само 1/3 от всички космически кораби, предприели пътуване към Марс, достигат крайната си цел, другите изчезват безследно. Учените предполагат, че причината може да се дължи на марсиански „Бермудски триъгълник“, който „поглъща“ космическите спътници.', NULL),
(7, 'Най-известната буря в познатият ни космос е „Голямото червено петно“ (Great Red spot), забелязана на повърността на Юпитер. В края на 2005-та година една друга буря на повърхността му се оцветява в червено, наречена „Малкото червено петно“ (Red spot Junior). Около два пъти по-малка, тя се е образувала от сливането на три бели, овални бури в периода 1998-2000г. Най-старата от тези три, може да бъде проследена повече от 90 години назад във времето!', NULL),
(8, 'Там денят е най-кратък в сравнение с всички планети в Слънчевата система. Юпитер прави пълно завъртане около оста си за 9 часа и 55 минути. Заради бързото си въртене, формата му е видимо сплескана.', NULL),
(9, 'Оста на Уран е наклонена на 98˚, което, погледнато от Земята, изглежда, все едно планетата се върти \"отгоре надолу\".', NULL),
(10, 'Луните на Уран са 27 ,като по-големите от тях са Миранда, Ариел, Умбриел, Титания и Оберон. Всички носят имената на герои от пиеси на Шекспир', NULL),
...
(12, 'Нептун има 14 луни, кръстени на различни морски божества и нимфи от гръцката митология. Най-големият му спътник е Тритон.', NULL),
(13, 'Гравитацията на Нептун е почти същата като тази на Земята.', NULL);
